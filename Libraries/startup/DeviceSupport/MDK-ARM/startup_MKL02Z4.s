...
__Vectors       DCD     __initial_sp  ; Top of Stack
                ...
                ; External Interrupts
                DCD     Reserved16_IRQHandler  ; DMA channel 0 transfer complete/error interrupt
                DCD     Reserved17_IRQHandler  ; DMA channel 1 transfer complete/error interrupt
                DCD     Reserved18_IRQHandler  ; DMA channel 2 transfer complete/error interrupt
                DCD     Reserved19_IRQHandler  ; DMA channel 3 transfer complete/error interrupt
                DCD     Reserved20_IRQHandler  ; Reserved interrupt 20
                DCD     FTFA_IRQHandler  ; FTFA command complete/read collision interrupt
                DCD     LVD_LVW_IRQHandler  ; Low Voltage Detect, Low Voltage Warning
                DCD     Reserved23_IRQHandler  ; Low Leakage Wakeup
                DCD     I2C0_IRQHandler  ; I2C0 interrupt
                DCD     I2C1_IRQHandler  ; Reserved interrupt 25
                ...
                DCD     Reserved36_IRQHandler  ; RTC interrupt
                DCD     Reserved37_IRQHandler  ; RTC seconds interrupt
                DCD     Reserved38_IRQHandler  ; PIT timer channel 0 interrupt
                DCD     Reserved39_IRQHandler  ; Reserved interrupt 39
                DCD     Reserved40_IRQHandler  ; Reserved interrupt 40
                DCD     Reserved41_IRQHandler  ; DAC0 interrupt
                DCD     Reserved42_IRQHandler  ; TSI0 interrupt
                DCD     MCG_IRQHandler  ; MCG interrupt
                DCD     LPTMR0_IRQHandler  ; LPTimer interrupt
                DCD     Reserved45_IRQHandler  ; Reserved interrupt 45
                DCD     PORTA_IRQHandler  ; Port A interrupt
                DCD     PORTB_IRQHandler  ; Port D interrupt
__Vectors_End
